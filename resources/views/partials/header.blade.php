<div class="x y z">
                <div class="ab ac ae af ag ah ai aj ak">
                    <div class="am an">
                        <div class="ao ap aq ar as at au ae">
                            <div class="av aw am ax">
                                <div class="y">
                ...
                <div class="ct y cu">
                    <div class="am an">
                        <div class="ao ap aq ar as at au ae">
                            <div class="ae am ax">
                                <div class="cv cw cx am cy cz da db dc dd de">
                                    <div class="df y">
                                        <h2 class="dg b dh di dj dk dl dm dn do dp dq dr ds dt du dv dw dx">Stay
                                            curious.</h2>
                                    </div>
                                    <div class="dy dz y da">
                                        <span class="cr">
                                            <h3 class="bv b ea eb by">Discover stories, thinking, and expertise from
                                                writers on any topic.</h3>
                                        </span>
                                    </div>
                                    <div class="cs">
                                        <span>
                                            <button
                                                class="bv b ec eb ca ed cc cd ce cf cg bh ch ci cj ck cl ee cm cn co cp cq">Start
                                                reading</button>
                                        </span>
                                    </div>
                                </div>
